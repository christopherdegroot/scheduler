...
const state = {
  ...
  appointments: {
    ...
    "6": { id: 1, time: "12pm", interview: {student: "David Gingrich", interviewer: 3} },
    "7": { id: 2, time: "1pm", interview: {student: "Kane Van Laare", interviewer: 1} },
  }
};
