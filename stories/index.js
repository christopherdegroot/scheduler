...
storiesOf("Appointment", module)
  ...
  .add("Form Editing", ()=> <Form student="Chris De Groot" interviewer={2} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} onChange={action("setInterviewer")}/> )
